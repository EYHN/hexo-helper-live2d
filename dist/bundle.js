...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = setContext;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_live2d_min__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_live2d_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_live2d_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LAppLive2DManager__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LAppDefine__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__LAppDefine__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__webglcontext__ = __webpack_require__(3);
...
const live2DMgr = new __WEBPACK_IMPORTED_MODULE_2__LAppLive2DManager__["a" /* default */]();
...
function init(modelurl) {
  ...
  dragMgr = new __WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework__["L2DTargetPoint"]();

  let ratio = height / width;
  let left = __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_LOGICAL_LEFT;
  let right = __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_LOGICAL_RIGHT;
  let bottom = -ratio;
  let top = ratio;

  viewMatrix = new __WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework__["L2DViewMatrix"]();


  viewMatrix.setScreenRect(left, right, bottom, top);

  viewMatrix.setMaxScreenRect(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_LOGICAL_MAX_LEFT,
    __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_LOGICAL_MAX_RIGHT,
    __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_LOGICAL_MAX_BOTTOM,
    __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_LOGICAL_MAX_TOP);

  viewMatrix.setMaxScale(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_MAX_SCALE);
  viewMatrix.setMinScale(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.VIEW_MIN_SCALE);

  projMatrix = new __WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework__["L2DMatrix44"]();
  projMatrix.multScale(1, (width / height));

  deviceToScreen = new __WEBPACK_IMPORTED_MODULE_1__lib_Live2DFramework__["L2DMatrix44"]();
  deviceToScreen.multTranslate(-width / 2.0, -height / 2.0);
  deviceToScreen.multScale(2 / width, -2 / width);

  gl = getWebGLContext();
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__webglcontext__["a" /* setContext */])(gl);
  if (!gl) {
...
function draw()
{
    __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default.a.reset();
    __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default.a.loadIdentity();
    dragMgr.update(); 
    live2DMgr.setDrag(dragMgr.getX(), dragMgr.getY());
    
    gl.clear(gl.COLOR_BUFFER_BIT);
    
    __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default.a.multMatrix(projMatrix.getArray());
    __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default.a.multMatrix(viewMatrix.getArray());
    __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default.a.push();
    ...
    __WEBPACK_IMPORTED_MODULE_4__lib_MatrixStack___default.a.pop();
}
...
function modelTurnHead(event)
{
    ...
    if (__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.DEBUG_MOUSE_LOG)
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = LAppLive2DManager;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PlatformManager__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LAppModel__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LAppDefine__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__LAppDefine__);
...
function LAppLive2DManager() {
  ...
  Live2D.init();
  __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework_js__["Live2DFramework"].setPlatformManager(new __WEBPACK_IMPORTED_MODULE_1__PlatformManager__["a" /* default */]);
...
LAppLive2DManager.prototype.createModel = function () {
  ...
  var model = new __WEBPACK_IMPORTED_MODULE_2__LAppModel__["a" /* default */]();
...
LAppLive2DManager.prototype.maxScaleEvent = function () {
  if (__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.DEBUG_LOG)
    console.log("Max scale event.");
  for (var i = 0; i < this.models.length; i++) {
    this.models[i].startRandomMotion(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.MOTION_GROUP_PINCH_IN,
      __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.PRIORITY_NORMAL);
  }
}
...
LAppLive2DManager.prototype.minScaleEvent = function () {
  ...
  for (var i = 0; i < this.models.length; i++) {
    this.models[i].startRandomMotion(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.MOTION_GROUP_PINCH_OUT,
      __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.PRIORITY_NORMAL);
  }
}
...
LAppLive2DManager.prototype.tapEvent = function (x, y) {
  ...
  for (var i = 0; i < this.models.length; i++) {
    ...
    if (this.models[i].hitTest(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.HIT_AREA_HEAD, x, y)) {
    ...
    else if (this.models[i].hitTest(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.HIT_AREA_BODY, x, y)) {

      if (__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.DEBUG_LOG)
        console.log("Tap body." + " models[" + i + "]");

      this.models[i].startRandomMotion(__WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.MOTION_GROUP_TAP_BODY,
        __WEBPACK_IMPORTED_MODULE_3__LAppDefine___default.a.PRIORITY_NORMAL);
    }
  }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = LAppModel;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_ModelSettingJson__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LAppDefine__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LAppDefine___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__LAppDefine__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack__);
...
function LAppModel()
{
    ...
    __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework__["L2DBaseModel"].prototype.constructor.call(this);
...
LAppModel.prototype = new __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework__["L2DBaseModel"]();
...
LAppModel.prototype.load = function(gl, modelSettingPath, callback)
{
    ...
    this.modelSetting = new __WEBPACK_IMPORTED_MODULE_1__lib_ModelSettingJson__["a" /* default */]();
            ...
            for (var i = 0; i < thisRef.modelSetting.getTextureNum(); i++)
            {
                ...
                thisRef.loadTexture(i, texPaths, function() {
                    ...
                    if( thisRef.isTexLoaded ) {
                        ...
                        {
                            thisRef.eyeBlink = new __WEBPACK_IMPORTED_MODULE_0__lib_Live2DFramework__["L2DEyeBlink"]();
                        }
                        ...
                        thisRef.preloadMotionGroup(__WEBPACK_IMPORTED_MODULE_2__LAppDefine___default.a.MOTION_GROUP_IDLE);
...
LAppModel.prototype.update = function()
{
    ...
    if(this.live2DModel == null) 
    {
        if (__WEBPACK_IMPORTED_MODULE_2__LAppDefine___default.a.DEBUG_LOG) console.error("Failed to update.");
    ...
    if (this.mainMotionManager.isFinished())
    {
        ...
        this.startRandomMotion(__WEBPACK_IMPORTED_MODULE_2__LAppDefine___default.a.MOTION_GROUP_IDLE, __WEBPACK_IMPORTED_MODULE_2__LAppDefine___default.a.PRIORITY_IDLE);
    }
...
LAppModel.prototype.startMotion = function(name, no, priority)
{
    ...
    {
        if (__WEBPACK_IMPORTED_MODULE_2__LAppDefine___default.a.DEBUG_LOG)
            console.error("Failed to motion.");
        return;
    }

    if (priority == __WEBPACK_IMPORTED_MODULE_2__LAppDefine___default.a.PRIORITY_FORCE) 
    {
...
LAppModel.prototype.draw = function(gl)
{
    ...
    __WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack___default.a.push();
    
    __WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack___default.a.multMatrix(this.modelMatrix.getArray());
    
    this.tmpMatrix = __WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack___default.a.getMatrix()
    this.live2DModel.setMatrix(this.tmpMatrix);
    this.live2DModel.draw();
    
    __WEBPACK_IMPORTED_MODULE_3__lib_MatrixStack___default.a.pop();
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = PlatformManager;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__webglcontext__ = __webpack_require__(3);
/**
 *
 *  You can modify and use this source freely
 *  only for the development of application related Live2D.
...
{ 
    ...
    loadedImage.onload = function() {
        // create texture
        var gl = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__webglcontext__["b" /* getContext */])();
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = ModelSettingJson;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Live2DFramework__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Live2DFramework___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Live2DFramework__);
...
{    
    var thisRef = this;
    var pm = __WEBPACK_IMPORTED_MODULE_0__Live2DFramework__["Live2DFramework"].getPlatformManager();
    pm.loadBytes(path, function(buf) {
